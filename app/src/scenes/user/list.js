...
const NewList = () => {
  ...
  return (
    <div>
      {/* Container */}
      <div className="px-2 pt-6 md:px-8">
        ...
        <div className="overflow-x-auto">
          <div className="grid grid-cols-2 gap-5 py-6 md:grid-cols-3 lg:grid-cols-4 ">
  ...
  return (
    <div
      ...
      <div className="relative flex items-start justify-center pt-6 pb-2">
        <div className="absolute top-0 left-0 z-10 w-full h-full overflow-hidden">
          <img
            ...
            className="z-10 object-cover w-full h-full overflow-hidden opacity-60"
          />
        </div>
        <div className="z-20 flex flex-col items-center">
          <img src={hit.avatar} className="object-contain w-20 h-20 rounded-full " />
      ...
      <div className="flex flex-col justify-between flex-1">
        <div className="flex flex-col items-center my-4 space-y-1 text-center">
          <p className="text-lg font-semibold">{hit.name}</p>
        </div>
      </div>
    </div>
  );
