        ...
        <form onSubmit={handleSubmit}>
          <React.Fragment>
            ...
            <div className="flex flex-wrap justify-between mt-3">
              ...
              <div className="w-full md:w-[48.5%]">
                <div>Email</div>
                <input className="projectsInput" type="email" value={values.email} onChange={(e) => setValues({ ...values, email: e.target.value })} />
              </div>
            </div>
            {/* second Row */}
            <div className="flex flex-wrap justify-between mt-3">
              <div className="w-full md:w-[48.5%]">
                <div>Address</div>
                <textarea className="h-auto py-2 projectsInput" name="address" value={values.address} onChange={(e) => setValues({ ...values, address: e.target.value })} />
              </div>
            </div>
            <hr className="my-4" />
